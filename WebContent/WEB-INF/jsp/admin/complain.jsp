				        ...
				        <c:when test="${not empty complainList}">
				            <c:forEach items="${complainList}" var="complain">  
				                <tr class="even gradeX">
				                    ...
				                    <td>
				                    	<a href="${pageContext.request.contextPath}/adminHandle/handleComplain/${complain.complainId}" >
				                   		${complain.complainHandleResult}</a> 
				                    </td>
				                    <td>
				                   	<a href="${pageContext.request.contextPath}/adminHandle/handleComplain/${complain.complainId}" >
				                   		处理 /</a> 
									<a href="${pageContext.request.contextPath}/adminHandle/deleteComplain/${complain.complainId}" >
										删除</a>
				                    </td>
								</tr>
				           </c:forEach>
