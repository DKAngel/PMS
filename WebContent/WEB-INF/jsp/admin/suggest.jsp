...
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/adminMain/suggest">建议管理</a></li>
    <li><a href="${pageContext.request.contextPath}/adminMain/suggest">建议查询</a></li>
    </ul>
    </div>
				        ...
				        <c:when test="${not empty suggestList}">
				            <c:forEach items="${suggestList}" var="suggest">  
				                <tr class="even gradeX">
				                	<td><fmt:formatDate value = "${suggest.suggestTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				                   
				                    <td>
				                   		${suggest.suggestContent}
				                    </td>
				                    <td>
				                    	<a href="${pageContext.request.contextPath}/adminHandle/handleSuggest/${suggest.suggestId}" title="点击查看" >
				                   		${suggest.suggestHandleResult}</a> 
				                    </td>
				                    <td>
				                   	<a href="${pageContext.request.contextPath}/adminHandle/handleSuggest/${suggest.suggestId}" >
				                   		处理 /</a> 
									<a href="${pageContext.request.contextPath}/adminHandle/deleteSuggest/${suggest.suggestId}" >
										删除</a>
				                    </td>
								</tr>
				           </c:forEach>
