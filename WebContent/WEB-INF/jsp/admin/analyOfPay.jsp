...
$(function() {
    var data = [{
        label: "小于50",
        data: <%= session.getAttribute("data50")%>
    }, {
        label: "50-100",
        data: <%= session.getAttribute("data100")%>
    }, {
        label: "100-150",
        data: <%= session.getAttribute("data150") %>
    },{
        label: "大于150",
        data: <%= session.getAttribute("data200") %>
    }];
...
<body>
    ...
    <li>统计分析</li>
    <li><a href="${pageContext.request.contextPath}/adminMain/analyOfPay">线上缴费分析</a></li>
    </ul>
    </div>
