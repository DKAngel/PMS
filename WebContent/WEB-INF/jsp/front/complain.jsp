...
<!-- right -->
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">投诉</h1>
                </div>
            </div>
            
            <div class="form-group">
            	<form action="${pageContext.request.contextPath}/frontIndex/complainHandle" method="post">
	            	<div class="form-group">
	                    <label style="font-size: 15px">请选择投诉类别</label><br><br>
	                    <select class="form-control" name="select">
	                        <option value="服务态度" selected="selected">服务态度</option>
	                        <option value="设备设施">设备设施</option>
	                        <option value="收费标准">收费标准</option>
	                        <option value="办事效率">办事效率</option>
	                        <option value="其他">其他</option>
	                    </select>
	                </div>
	                <br>
	                <label style="font-size: 15px" >请详细填写投诉内容</label>
	                <br>
		            <div align="center">
		            	<textarea class="form-control" name="textarea" rows="10"></textarea><br>
		               	<div align="center">
		               		<button type="submit" class="btn btn-outline btn-primary btn-lg">提  交  投  诉</button>
		            	</div>
	            	</div>
            	</form>
        	</div>
