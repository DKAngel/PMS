...
<!-- right -->
		...
		<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">建议历史记录</h1>
                </div>
            </div>
							            ...
							            <c:when test="${not empty suggestList}">
							                <c:forEach items="${suggestList}" var="suggest">  
							                    <tr class="even gradeX">
							                        ...
							                        <td>
							                        	${suggest.suggestHandleResult}
							                        </td>
							                        <td>
							                        	<a href="${pageContext.request.contextPath}/frontDetail/showSuggest/${suggest.suggestId}" >
							                        		查看/</a> 
				        								<a href="${pageContext.request.contextPath}/frontDetail/deleteSuggest/${suggest.suggestId}" >
				        									删除</a>
							                        </td>
												</tr>
							                </c:forEach>
