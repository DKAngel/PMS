...
<!-- right -->
		...
		<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">维修历史记录</h1>
                </div>
            </div>
							            ...
							            <c:when test="${not empty upkeepList}">
							                <c:forEach items="${upkeepList}" var="upkeep">  
							                    <tr class="even gradeX">
							                        ...
							                        <td>
							                        	${upkeep.upkeepContent}
							                        </td>
							                        <td>
							                        	${upkeep.upkeepResult}
							                        </td>
							                        <td>
							                        	<a href="${pageContext.request.contextPath}/frontDetail/showUpkeep/${upkeep.upkeepId}" >
							                        		查看/</a> 
				        								<a href="${pageContext.request.contextPath}/frontDetail/deleteUpkeep/${upkeep.upkeepId}" >
				        									删除</a>
							                        </td>
												</tr>
							                </c:forEach>
