							            ...
							            <c:when test="${not empty chatList}">
							                <c:forEach items="${chatList}" var="chat">  
							                    <tr class="even gradeX">
							                        ...
							                        <td>
							                        	<a href="${pageContext.request.contextPath}/frontChatHandle/showChat/${chat.chatId}" >
							                        		查看/</a> 
				        								<a href="${pageContext.request.contextPath}/frontChatHandle/deleteChat/${chat.chatId}" >
				        									删除</a>
							                        </td>
												</tr>
							                </c:forEach>
