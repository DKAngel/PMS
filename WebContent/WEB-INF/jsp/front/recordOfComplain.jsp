...
<!-- right -->
		...
		<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">投诉历史记录</h1>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
							        <c:choose>
							            <c:when test="${not empty complainList}">
							                <c:forEach items="${complainList}" var="complain">  
							                    <tr class="even gradeX">
							                        ...
							                        <td>
							                        	${complain.complainHandleResult}
							                        </td>
							                        <td>
							                        	<a href="${pageContext.request.contextPath}/frontDetail/showComplain/${complain.complainId}" >
							                        		查看/</a> 
				        								<a href="${pageContext.request.contextPath}/frontDetail/deleteComplain/${complain.complainId}" >
				        									删除</a>
							                        </td>
												</tr>
							                </c:forEach>
