...
<!-- right -->
        <div id="page-wrapper">
			<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">投诉详情</h1>
                </div>
            </div>
            <div >
                <div class="panel ">
                    <div class="panel-heading">
                       <h3>投诉类型：${ complain.complainType }</h3>
                       <h5>投诉时间：<fmt:formatDate value = "${complain.complainTime}" pattern="yyyy-MM-dd HH:mm:ss"/></h5>
                    </div>
                    ...
                    <div class="panel-heading">
                    	<h4 style="text-align:left">处理人：${ adminName }</h4>
                       	...
                       	<h4>处理结果：</h4>
                        <p>${ complain.complainHandleResult }</p>
                    </div>
