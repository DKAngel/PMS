...
<!-- right -->
        <div id="page-wrapper">
			<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">维修详情</h1>
                </div>
            </div>
            <div >
                <div class="panel ">
                    <div class="panel-heading">
                       <h3>维修类型：${ upkeep.upkeepType }</h3>
                       <h5>维修时间：<fmt:formatDate value = "${upkeep.upkeepTime}" pattern="yyyy-MM-dd HH:mm:ss"/></h5>
                    </div>
                    
                    <div class="panel-body">
                        <h4>维修内容：</h4>
                        <p>${ upkeep.upkeepContent }</p>
                    </div>
					<hr>
                    <div class="panel-heading">
                    	<h4 style="text-align:left">处理人：${ adminName }</h4>
                       	...
                       	<h4>处理过程：</h4>
                        <p>${ upkeep.upkeepProcess }</p>
                       	<h4>处理结果：</h4>
                        <p>${ upkeep.upkeepResult }</p>
                    </div>
