        ...
        <div id="page-wrapper">
            ...
            <div class="form-group">
           		<div class="panel-body">
                	<h3>${ activity.activityTheme }</h3><br>
                	<h5>活动策划：${ activity.ownersName }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                	发布时间：<fmt:formatDate value = "${activity.activityPtime}" pattern="yyyy-MM-dd HH:mm:ss"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                	举行时间：<fmt:formatDate value = "${activity.activityHtime}" pattern="yyyy-MM-dd HH:mm:ss"/></h5>
                    <div class="panel-body">
